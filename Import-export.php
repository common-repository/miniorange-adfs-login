...
define( "Tab_Class_Names", serialize( array(
	"SSO_Login"         => 'mo_adfs_options_enum_sso_login',
	"Identity_Provider" => 'mo_options_enum_identity_provider',
	"Service_Provider"  => 'mo_adfs_options_enum_service_provider',
	"Attribute_Mapping" => 'mo_adfs_options_enum_attribute_mapping',
	"Role_Mapping"      => 'mo_adfs_options_enum_role_mapping',
 ...
 */
function miniorange_keep_configuration_saml_adfs() {
...
function mo_get_version_informations(){
	...
	$array_version["OPEN_SSL"] = mo_adfs_is_openssl_installed();
	$array_version["CURL"] = mo_adfs_is_curl_installed();
    $array_version["ICONV"] = mo_adfs_is_iconv_installed();
    $array_version["DOM"] = mo_adfs_is_dom_installed();
