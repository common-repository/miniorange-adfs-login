...
class mo_adfs_options_enum_service_provider extends BasicEnum{
	const Identity_name = 'mo_adfs_sso_saml_identity_name';
	const Login_URL = 'mo_adfs_sso_saml_login_url';
	const Issuer = 'mo_adfs_sso_saml_issuer';
	const X509_certificate = 'mo_adfs_sso_saml_x509_certificate';
}

class mo_adfs_options_enum_attribute_mapping extends BasicEnum{
	const Attribute_First_name = 'mo_adfs_sso_first_name';
	const Attribute_Last_name = 'mo_adfs_sso_last_name';
}

class mo_adfs_options_enum_role_mapping extends BasicEnum{
	const Role_default_role = 'mo_adfs_sso_default_user_role';
}

class mo_adfs_options_enum_sso_login extends BasicEnum{
	const Force_authentication = 'mo_adfs_sso_force_authentication';
}
...
class mo_options_plugin_constants extends  BasicEnum{
     const CMS_Name = "WP";
     const Application_Name = "Login with ADFS";
